...
get.Metazoan.plotting.parameters <- function(metazoan_tree_files){
  ...
  pal_13 <- turbo(13)
  pal_14 <- turbo(14)
  metazoan_palette <- c(Bilateria = "#CC79A7", Cnidaria = "#009E73", Ctenophora = "#56B4E9", Porifera = "#E69F00", Placozoa = "#000000", Outgroup = "#999999")
  # Assemble list of parameters
  met_params <- list(map_1 = list(cols = c(rep(metazoan_palette[["Cnidaria"]], 15),
                                           rep(metazoan_palette[["Bilateria"]], 6),
                                           rep(metazoan_palette[["Placozoa"]], 1),
                                           rep(metazoan_palette[["Porifera"]], 19),
                                           rep(metazoan_palette[["Ctenophora"]], 30),
                                           rep(metazoan_palette[["Outgroup"]], 5)),
                     ...
                     map_2 = list(cols = c(rep(metazoan_palette[["Cnidaria"]], 15),
                                           rep(metazoan_palette[["Bilateria"]], 6),
                                           rep(metazoan_palette[["Placozoa"]], 1),
                                           rep(metazoan_palette[["Porifera"]], 19),
                                           rep(metazoan_palette[["Ctenophora"]], 30),
                                  ...
                                  outgroup = c("Salpingoeca_pyxidium", "Monosiga_ovata", "Acanthoeca_sp", "Salpingoeca_rosetta", "Monosiga_brevicolis") ),
                     map_3 = list(cols = c(rep(metazoan_palette[["Cnidaria"]], 15),
                                           rep(metazoan_palette[["Bilateria"]], 6),
                                           rep(metazoan_palette[["Placozoa"]], 1),
                                           rep(metazoan_palette[["Porifera"]], 19),
                                           rep(metazoan_palette[["Ctenophora"]], 30),
                                  ...
                                  outgroup = c("Salpingoeca_pyxidium", "Monosiga_ovata", "Acanthoeca_sp", "Salpingoeca_rosetta", "Monosiga_brevicolis") ),
                     mcp_1 = list(cols = c(rep(metazoan_palette[["Cnidaria"]], 15),
                                           rep(metazoan_palette[["Bilateria"]], 6),
                                           rep(metazoan_palette[["Placozoa"]], 1),
                                           rep(metazoan_palette[["Porifera"]], 19),
                                           rep(metazoan_palette[["Ctenophora"]], 30),
                                  ...
                                  outgroup = c("Salpingoeca_pyxidium", "Monosiga_ovata", "Acanthoeca_sp", "Salpingoeca_rosetta", "Monosiga_brevicolis") ),
                     mcp_2 = list(cols = c(rep(metazoan_palette[["Cnidaria"]], 15),
                                           rep(metazoan_palette[["Bilateria"]], 6),
                                           rep(metazoan_palette[["Placozoa"]], 1),
                                           rep(metazoan_palette[["Porifera"]], 19),
                                           rep(metazoan_palette[["Ctenophora"]], 30),
                                  ...
                                  outgroup = c("Salpingoeca_pyxidium", "Monosiga_ovata", "Acanthoeca_sp", "Salpingoeca_rosetta", "Monosiga_brevicolis") ),
                     mcp_3 = list(cols = c(rep(metazoan_palette[["Cnidaria"]], 15),
                                           rep(metazoan_palette[["Bilateria"]], 6),
                                           rep(metazoan_palette[["Placozoa"]], 1),
                                           rep(metazoan_palette[["Porifera"]], 19),
                                           rep(metazoan_palette[["Ctenophora"]], 30),
                                  ...
                                  outgroup = c("Salpingoeca_pyxidium", "Monosiga_ovata", "Acanthoeca_sp", "Salpingoeca_rosetta", "Monosiga_brevicolis") ),
                     sp = list(cols = c(rep(metazoan_palette[["Cnidaria"]], 15),
                                        rep(metazoan_palette[["Bilateria"]], 6),
                                        rep(metazoan_palette[["Placozoa"]], 1),
                                        rep(metazoan_palette[["Porifera"]], 19),
                                        rep(metazoan_palette[["Ctenophora"]], 30),
